...
//memanggil method tampil_data_penjualan yang berfungsi menampilkan data penjualan untuk ditampung ke dalam sebuah variabel
...
<head>
    ...
    <title>Manajemen Data Penjualan Tas</title>
...
<body>
    ...
    <div class="container-fluid">
    <a href="form_tambah_penjualan.php" class="btn btn-primary mt-4 mb-3">Input Data Penjualan</a>
        ...
        <table class="table table-bordered mt-4 table-striped display" id="table_id" width="100%" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <a href="update_penjualan.php?id_penjualan=<?php echo $row['id_penjualan']; ?>" class="btn btn-success">Update</a>
					<a href="proses_penjualan.php?action=delete&id_penjualan=<?php echo $row['id_penjualan']; ?>" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            <?php
            //increment
